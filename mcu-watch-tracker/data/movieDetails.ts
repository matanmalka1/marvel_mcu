...
export const MOVIE_DETAILS: Record<string, MovieDetails> = {
  ...
  "captain-america-civil-war": {
    knowledge: {
      ...
      objects: [
        "מילות הקוד לשליטה ב-Bucky",
        "המתקן הסובייטי בסיביר",
        "מגן ה-Captain America",
      ],
      connections: [
  ...
  "thor-ragnarok": {
    knowledge: {
      ...
      organizations: [
        "אסגרד",
        "Sakaar / משחקי הגלדיאטורים של ה-Grandmaster",
        "ה-Valkyries לשעבר",
      ],
  ...
  "avengers-endgame": {
    knowledge: {
      ...
      objects: [
        "חליפות ה-Quantum Realm",
        "כפפת האינסוף (גרסה חדשה)",
        "מכונת הנסיעה בזמן",
      ],
      connections: [
  ...
  "spider-man-no-way-home": {
    knowledge: {
      ...
      objects: [
        "כישוף מחיקת הזהות/הזיכרון",
        "Mirror Dimension",
        'מכשירי ה"ריפוי" לכל נבל',
      ],
      connections: [
  ...
  "black-panther-wakanda-forever": {
    knowledge: {
      ...
      objects: [
        "הצמח בעל צורת הלב",
        "חליפת ה-Black Panther החדשה",
        "גלאי הויבראניום של Riri",
      ],
      connections: [
  ...
  "the-fantastic-four-first-steps": {
    knowledge: {
      ...
      objects: [
        "קרני הקוסמוס שהעניקו את הכוחות",
        "מערכת הטלפורטציה הפלנטרית",
        "לוח הגלישה של ה-Silver Surfer",
      ],
      connections: [],
    },
    review: {
