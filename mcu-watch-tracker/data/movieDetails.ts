...
export const MOVIE_DETAILS: Record<string, MovieDetails> = {
  "captain-america-the-first-avenger": {
      knowledge: {
          summary: "מלחמת העולם השנייה. Steve Rogers, מתגייס שנדחה שוב ושוב, נבחר לניסוי סופר-סולג'ר אמריקאי ויוצא למלחמה מול HYDRA — זרוע מדעית שפרשה מהנאצים ומחזיקה במקור אנרגיה עתיק שאינו מהעולם הזה.",
          concepts: [
      ...
      review: {
          ...
          metacriticScore: 66,
          consensus: "הרפתקה מיושנת ברוחה עם אפקטים דיגיטליים מודרניים — אחד הפרקים הבטוחים והאמינים ביותר ביקום הקולנועי של מארוול.",
  ...
  "captain-marvel": {
      knowledge: {
          summary: "1995. לוחמת בשם Vers מגלה שהזיכרונות שלה הושתלו ושהמלחמה שבה נלחמה אינה מה שסיפרו לה. במקביל, סוכן צעיר ב-S.H.I.E.L.D בשם Nick Fury נתקל לראשונה בחיים מחוץ לכדור הארץ.",
          concepts: [
      ...
      review: {
          ...
          metacriticScore: 64,
          consensus: "עמוס באקשן, הומור ורגעים ויזואליים — Captain Marvel מציג את הגיבורה החדשה של ה-MCU עם סיפור מקור שמנצל היטב את הנוסחה המוכרת של הפרנצ'ייז.",
          source: "Rotten Tomatoes",
  ...
  "iron-man": {
      knowledge: {
          summary: "Tony Stark, יורש תעשיית נשק ומהנדס יוצא דופן, נחטף ובונה בשבי כור אנרגיה זעיר וחליפת שריון כדי לברוח. בחזרתו הוא עוצר את ייצור הנשק ומגלה שהאיום האמיתי יושב בתוך החברה שלו.",
          concepts: [
      ...
      review: {
          ...
          metacriticScore: 79,
          consensus: "מונע על ידי הקסם התוסס של Robert Downey Jr., Iron Man מזריק טורבו לז'אנר גיבורי-העל עם חוכמה עדינה ותחושת כיף מדבקת.",
          source: "Rotten Tomatoes",
  ...
  "iron-man-2": {
      knowledge: {
          summary: "הפלדיום שמניע את הכור בחזה של Tony מרעיל אותו לאט, בזמן שהממשל דורש שיעביר את הטכנולוגיה לידיים אחרות. במקביל מגיע Ivan Vanko, בנו של שותף ותיק של Howard Stark, לגבות חוב מהדור הקודם.",
          concepts: [
      ...
      review: {
          ...
          metacriticScore: 57,
          consensus: "לא בדיוק אותה נשימת אוויר צח כמו Iron Man הראשון, אבל ההמשך מתקרב אליה עם ביצועים טובים ועלילה עמוסת אקשן.",
          source: "Rotten Tomatoes",
  ...
  "the-incredible-hulk": {
      knowledge: {
          summary: "מדען בשם Bruce Banner, שניסוי בקרינת גאמא הפך אותו למפלצת ירוקה בכל פרץ זעם, מנסה למצוא תרופה תוך בריחה מהצבא האמריקאי. כשקצין בריטי חסר סבלנות עובר טיפול דומה ומשתגע לגמרי, רק ה-Hulk יכול לעצור אותו.",
          concepts: [
      ...
      review: {
          ...
          metacriticScore: 61,
          consensus: "הסרט לא מגיע לגמרי להצלחה המרשימה שמעריצי הענק הירוק קיוו לה, אך מציע מספיק אקשן ירוק כדי לפצות על עלילה לעיתים דלה.",
          source: "Rotten Tomatoes",
  ...
  "thor": {
      knowledge: {
          summary: "Thor, יורש אסגרד היהיר, מגורש לכדור הארץ ומאבד את כוחו לאחר שכמעט הצית מלחמה עם ענקי הקרח. רק כשהוא לומד ענווה ואהבה הוא מוכיח שהוא ראוי להרים שוב את הפטיש שלו, Mjolnir.",
          concepts: [
      ...
      review: {
          ...
          metacriticScore: 57,
          consensus: "בלוקבאסטר מסנוור שממתן את היקפו הרחב בהומור, שנינות ודרמה אנושית — Thor הוא בידור מארוול אדיר.",
          source: "Rotten Tomatoes",
  ...
  "the-avengers": {
      knowledge: {
          summary: "Loki גונב את ה-Tesseract ומתכנן לפתוח שער לפלישה חייזרית על כדור הארץ. Nick Fury מפעיל את Avengers Initiative ומאחד קבוצת גיבורים בלתי-צפויה כדי לעצור אותו לפני שניו יורק תיפול.",
          concepts: [
      ...
      review: {
          ...
          metacriticScore: 69,
          consensus: "הודות לתסריט שמדגיש את האנושיות של הגיבורים ושפע רגעי אקשן-על, The Avengers עומד בציפיות הגבוהות ומרים את הרף למארוול הקולנועית.",
          source: "Rotten Tomatoes",
  ...
  "thor-the-dark-world": {
      knowledge: {
          summary: "כוח קדום בשם Aether, שפעם כמעט החזיר את היקום לחשכה, מתעורר מחדש ומאיים על Jane Foster. Thor נאלץ להסתמך על אחיו הכלוא, Loki, כדי להצילה ולעצור את האלפים האפלים.",
          concepts: [
      ...
      review: {
          ...
          metacriticScore: 54,
          consensus: "לא בהכרח הסרט הטוב ביותר שיצא מיקום מארוול, אך Thor: The Dark World עדיין מציע הומור והימורים גבוהים כפי שהמעריצים ציפו.",
          source: "Rotten Tomatoes",
  ...
  "iron-man-3": {
      knowledge: {
          summary: "טרור בדמות \"Mandarin\" תוקף את ארה\"ב בזמן ש-Tony Stark מתמודד עם התקפי חרדה בעקבות האירועים בניו יורק. מאחורי הקלעים מסתתרת מזימה של מדען זנוח שפיתח טיפול ביולוגי הרסני בשם Extremis.",
          concepts: [
      ...
      review: {
          rottenTomatoesScore: 79,
          metacriticScore: 62,
          consensus: "בעזרת כוכב ראשי כריזמטי, סצנות אקשן מרשימות וכמה הפתעות, Iron Man 3 הוא הרפתקה שנונה ומהנה ותוספת חזקה לקאנון של מארוול.",
          source: "Rotten Tomatoes",
  ...
  "captain-america-the-winter-soldier": {
      knowledge: {
          summary: "Steve Rogers מגלה ש-S.H.I.E.L.D, הארגון שהוא משרת, חדור מבפנים על ידי HYDRA — אויב שחשב שהובס עוד במלחמת העולם השנייה. בדרך הוא נתקל במתנקש מסתורי שמתברר כחברו הטוב ביותר, שנחשב מת.",
          concepts: [
      ...
      review: {
          ...
          metacriticScore: 70,
          consensus: "מותח ומחוכם מבחינה פוליטית, Captain America: The Winter Soldier הוא פרק מעולה בקאנון האווינג'רס שבטוח יהנה את מעריצי מארוול.",
          source: "Rotten Tomatoes",
  ...
  "guardians-of-the-galaxy": {
      knowledge: {
          summary: "Peter Quill, שנחטף מכדור הארץ כילד, גונב חפץ מסתורי שמושך אליו רודף חסר רחמים בשם Ronan. כדי לעצור אותו, הוא נאלץ להתחבר עם קבוצת פושעי חלל בלתי צפויה שהופכת למשפחה.",
          concepts: [
      ...
      review: {
          rottenTomatoesScore: 91,
          metacriticScore: 76,
          consensus: "Guardians of the Galaxy חצוף בדיוק במידה שמעריצי הקומיקס ציפו לו — כמו גם מצחיק, מותח, מלא לב ועמוס פאר ויזואלי.",
          source: "Rotten Tomatoes",
  ...
  "guardians-of-the-galaxy-vol-2": {
      knowledge: {
          summary: "הגארדיאנים מתמודדים עם גזע חייזרי מתנשא, ואז עם דמות אלוהית שמתגלה כאביו הביולוגי הנעלם של Quill. מאחורי החיוך המקסים שלו מסתתרת תוכנית איומה להשתלט על היקום.",
          concepts: [
      ...
      review: {
          ...
          metacriticScore: 67,
          consensus: "העלילה עמוסת האקשן, החזותיים המסנוורים וההומור החצוף של Guardians of the Galaxy Vol. 2 מצטרפים לסרט המשך כיפי כמעט כמו קודמו — גם אם לא רענן באותה מידה.",
          source: "Rotten Tomatoes",
  ...
  "avengers-age-of-ultron": {
      knowledge: {
          summary: "בניסיון להגן על העולם, Tony Stark ו-Bruce Banner יוצרים בינה מלאכותית בשם Ultron — אך זו מגיעה למסקנה שהדרך היחידה להציל את האנושות היא להשמיד אותה. ה-Avengers נלחמים על עתיד סוקוביה ועל עתיד עצמם כצוות.",
          concepts: [
      ...
      review: {
          ...
          metacriticScore: 66,
          consensus: "תוסס ומסנוור, Avengers: Age of Ultron הוא סרט המשך עמוס מדי אך ברובו מספק, שמאחד מחדש את הרכב הענק של קודמו עם כמה תוספות חדשות ואויב ראוי.",
          source: "Rotten Tomatoes",
  ...
  "ant-man": {
      knowledge: {
          summary: "פורץ לשעבר, Scott Lang, מגויס על ידי מדען ותיק כדי לגנוב טכנולוגיית כיווץ מסוכנת לפני שהיא נמכרת לגורמים עוינים. בדרך הוא הופך לגיבור-על זעיר בשם Ant-Man.",
          concepts: [
      ...
      review: {
          ...
          metacriticScore: 64,
          consensus: "בהובלת ביצוע מקסים של Paul Rudd, Ant-Man מציע ריגושי מארוול בקנה מידה מתאים — גם אם לא בצורה חלקה כמו קודמיו המצליחים ביותר.",
          source: "Rotten Tomatoes",
  ...
  "captain-america-civil-war": {
      knowledge: {
          summary: "אירוע קטלני שגורם ה-Avengers מוביל לחקיקה בין-לאומית שמפצלת את הצוות לשניים — Tony Stark שתומך בפיקוח, ו-Steve Rogers שמסרב לוותר על עצמאות. כשחברו הטוב ביותר של Steve מואשם בפיגוע, המלחמה הופכת אישית.",
          concepts: [
      ...
      review: {
          rottenTomatoesScore: 90,
          metacriticScore: 75,
          consensus: "Captain America: Civil War פותח את הגל הבא של סרטי מארוול עם בלוקבאסטר-על עמוס אקשן, עלילה לא-מצוירת בעליל, והאומץ לחקור נושאים מעוררי מחשבה.",
          source: "Rotten Tomatoes",
  ...
  "black-widow": {
      knowledge: {
          summary: "בורחת מהחוק אחרי אירועי Civil War, Natasha Romanoff נאלצת להתמודד עם עברה כשהיא מתאחדת עם \"אחותה\" המדומה, Yelena, כדי להפיל את מי שיצר אותן — מפעל שלם של מתנקשות בשליטת מוח.",
          concepts: [
      ...
      review: {
          rottenTomatoesScore: 79,
          metacriticScore: 68,
          consensus: "הנושאים העמוקים של Black Widow קצת טובעים תחת ריבוי האקשן, אך זו עדיין הרפתקה עצמאית מהנה עם צוות משנה מצוין.",
          source: "Rotten Tomatoes",
  ...
  "black-panther": {
      knowledge: {
          summary: "אחרי מות אביו, T'Challa הופך למלך וואקנדה — מדינה שמסתירה מהעולם עושר טכנולוגי עצום המבוסס על ויבראניום. כשקרוב משפחה נטוש חוזר לתבוע את הכתר, T'Challa נאלץ להתמודד עם מורשת שגיאות שהוריש לו אביו.",
          concepts: [
      ...
      review: {
          ...
          metacriticScore: 88,
          consensus: "Black Panther מרים את קולנוע גיבורי-העל לגבהים מרתקים חדשים, ומספר אחד הסיפורים הסוחפים ביותר ב-MCU — תוך הצגת כמה מהדמויות המפותחות ביותר שלו.",
          source: "Rotten Tomatoes",
  ...
  "spider-man-homecoming": {
      knowledge: {
          summary: "אחרי שהשתתף בקרב ברלין, Peter Parker חוזר לתיכון אך ממשיך לפעול כ-Spider-Man בשכונה. כשהוא מגלה סוחר נשק שמוכר טכנולוגיית חייזרים גנובה, הוא נגרר לעימות גדול ממנו הרבה.",
          concepts: [
      ...
      review: {
          ...
          metacriticScore: 73,
          consensus: "Spider-Man: Homecoming עושה כל שריבוט שני יכול לעשות, ומספק הרפתקה צבעונית ומהנה שמשתלבת בטבעיות ב-MCU הענק בלי להיסחף מדי לבניית פרנצ'ייז.",
          source: "Rotten Tomatoes",
  ...
  "doctor-strange": {
      knowledge: {
          summary: "מנתח מוח מבריק אך יהיר, Stephen Strange, מאבד את השימוש בידיו בתאונת דרכים. בחיפוש נואש אחר מרפא הוא מגיע ל-Kamar-Taj ומגלה עולם שלם של קסם ומימדים חוצי-מציאות.",
          concepts: [
      ...
      review: {
          ...
          metacriticScore: 72,
          consensus: "Doctor Strange מאזן בכישרון בין חומר המקור החריג שלו לבין המגבלות של בלוקבאסטר ה-MCU, ומספק סיפור מקור מהנה מאוד לגיבור-על.",
          source: "Rotten Tomatoes",
  ...
  "thor-ragnarok": {
      knowledge: {
          summary: "Thor מגלה שיש לו אחות בכורה נשכחת, Hela, שמשתלטת על אסגרד ומפילה אותו לכוכב זבל מרוחק. כדי להציל את עמו הוא נאלץ להתאחד עם Loki, Hulk וחיילת אסגרדית אבודה.",
          concepts: [
      ...
      review: {
          ...
          metacriticScore: 74,
          consensus: "מרגש, מצחיק, ומעל הכל כיפי — Thor: Ragnarok הוא הרפתקה קוסמית צבעונית שמציבה רף חדש לפרנצ'ייז שלו.",
          source: "Rotten Tomatoes",
  ...
  "ant-man-and-the-wasp": {
      knowledge: {
          summary: "שנתיים אחרי Civil War, Scott Lang נמצא במעצר בית. Hank Pym ובתו Hope פונים אליו שוב כשהם מזהים אות אפשרי מ-Janet van Dyne, שנעלמה ל-Quantum Realm לפני שלושה עשורים.",
          concepts: [
      ...
      review: {
          ...
          metacriticScore: 70,
          consensus: "סרט גיבורי-על קליל ובהיר יותר, מונע על ידי הכריזמה חסרת המאמץ של Paul Rudd ו-Evangeline Lilly — Ant-Man and the Wasp מציע הפוגה רעננה שה-MCU היה זקוק לה.",
          source: "Rotten Tomatoes",
  ...
  "avengers-infinity-war": {
      knowledge: {
          summary: "Thanos יוצא למסע להשיג את כל שש אבני האינסוף ולמחוק מחצית מהיקום. ה-Avengers וה-Guardians of the Galaxy מתפזרים בין כמה חזיתות במאבק ייאוש לעצור אותו — וכושלים.",
          concepts: [
      ...
      review: {
          rottenTomatoesScore: 85,
          metacriticScore: 68,
          consensus: "Avengers: Infinity War מצליח לאזן מערך מסחרר של גיבורי MCU במאבק מול האיום הגדול ביותר שלהם, והתוצאה היא בלוקבאסטר מרגש ומותח שמגשים ברובו את השאיפות הענקיות שלו.",
          source: "Rotten Tomatoes",
  ...
  "avengers-endgame": {
      knowledge: {
          summary: "חמש שנים אחרי ה-snap ההרסני של Thanos, שרידי ה-Avengers מוצאים דרך להשתמש בנסיעה בזמן כדי לאסוף את אבני האינסוף מהעבר ולהחזיר את מי שנעלם — אך הניצחון גובה מחיר איום.",
          concepts: [
      ...
      review: {
          ...
          metacriticScore: 78,
          consensus: "מסקנה משביעת רצון ומרגשת רגשית לשנים-עשר שנות הקמת יקום מארוול הקולנועי, ש(ברובה) מצדיקה את האורך העצום שלה.",
          source: "Rotten Tomatoes",
  ...
  "shang-chi-and-the-legend-of-the-ten-rings": {
      knowledge: {
          summary: "Shaun, מלצר חניה בסן פרנסיסקו, מתגלה כ-Shang-Chi — בנו של Xu Wenwu, מנהיג ארגון פשע עתיק ובעל עשר טבעות רבות-עוצמה. הוא נגרר בחזרה למשפחתו ולסוד שאביו מסתיר על אמו שנעלמה.",
          concepts: [
      ...
      review: {
          rottenTomatoesScore: 92,
          metacriticScore: 71,
          consensus: "Shang-Chi and the Legend of the Ten Rings לא לגמרי חף מהנוסחה המוכרת של מארוול, אך סיפור המקור המרגש הזה מרחיב את ה-MCU בכמה כיוונים בבת אחת.",
          source: "Rotten Tomatoes",
  ...
  "spider-man-far-from-home": {
      knowledge: {
          summary: "אחרי היעלמות והחזרה (\"Blip\"), Peter Parker יוצא לטיול לימודים באירופה ומקווה להתרחק מאחריות הגיבור-על. אבל Nick Fury לא מתכוון לתת לו חופשה — במיוחד לא כשישויות איתני-טבע ענקיות מתחילות לתקוף ערים אירופיות.",
          concepts: [
      ...
      review: {
          rottenTomatoesScore: 91,
          metacriticScore: 69,
          consensus: "תערובת קלילה ובלתי צפויה של רומנטיקת נעורים ופעולת גיבורי-על, Spider-Man: Far From Home מציבה בסגנון את הבמה לעידן הבא של ה-MCU.",
          source: "Rotten Tomatoes",
  ...
  "eternals": {
      knowledge: {
          summary: "קבוצת ישויות בנות-אלמוות בשם Eternals, ששלחו לכדור הארץ לפני אלפי שנים כדי להגן על בני האדם מפני מפלצות בשם Deviants, מתאחדת מחדש כשמתברר שהמשימה האמיתית שלהן הייתה שונה — ומסוכנת בהרבה — ממה שחשבו.",
          concepts: [
      ...
      review: {
          ...
          metacriticScore: 52,
          consensus: "אפוס גיבורי-על שאפתני שמצליח לפעמים באותה מידה שהוא נכשל — Eternals לוקח את ה-MCU לכיוונים מסקרנים, ולעיתים גם מבלבלים.",
          source: "Rotten Tomatoes",
  ...
  "spider-man-no-way-home": {
      knowledge: {
          summary: "אחרי ש-Mysterio חושף בפומבי ש-Peter הוא Spider-Man, הוא מבקש מ-Doctor Strange לגרום לעולם לשכוח את זהותו. הכישוף משתבש ופותח את המולטיוורס, ומביא נבלים וגיבורי Spider-Man ממציאויות אחרות.",
          concepts: [
      ...
      review: {
          rottenTomatoesScore: 93,
          metacriticScore: 71,
          consensus: "ספיידרמן גדול ונועז יותר, No Way Home מרחיב את היקף הפרנצ'ייז וההימורים שלו מבלי לאבד את ההומור והלב.",
          source: "Rotten Tomatoes",
  ...
  "doctor-strange-in-the-multiverse-of-madness": {
      knowledge: {
          summary: "America Chavez, נערה עם יכולת לקפוץ בין יקומים מקבילים, נרדפת על ידי ישות אפלה. Doctor Strange מגלה של-Wanda Maximoff יש תוכניות משלה למולטיוורס — ומוכנה להרוס הכל כדי לממש אותן.",
          concepts: [
      ...
      review: {
          ...
          metacriticScore: 60,
          consensus: "Doctor Strange in the Multiverse of Madness עמל תחת משקל ה-MCU המתפרש, אך הבימוי הייחודי של Sam Raimi יוצר כישוף מהנה.",
          source: "Rotten Tomatoes",
  ...
  "black-panther-wakanda-forever": {
      knowledge: {
          summary: "אחרי מותו של המלך T'Challa, וואקנדה מתאבלת בזמן שהיא מתמודדת עם לחץ עולמי גובר להשיג ויבראניום. חיפוש אחר משאבים נוספים חושף ממלכה תת-ימית נסתרת שמאיימת להכריז מלחמה.",
          concepts: [
      ...
      review: {
          ...
          metacriticScore: 67,
          consensus: "מחווה נוגעת ללב שמניעה את הפרנצ'ייז קדימה בצורה משביעת רצון, Black Panther: Wakanda Forever הוא ניצחון שאפתני ומרגש רגשית עבור ה-MCU.",
          source: "Rotten Tomatoes",
  ...
  "thor-love-and-thunder": {
      knowledge: {
          summary: "Thor, אבוד לאחר איבוד כמעט כל מה שאהב, מתמודד עם Gorr the God Butcher — לוחם שאיבד את אמונתו ונשבע להשמיד את כל האלים. הוא מתאחד עם Valkyrie ועם אהובתו לשעבר Jane Foster, שהפכה בעצמה ל-Mighty Thor.",
          concepts: [
      ...
      review: {
          ...
          metacriticScore: 57,
          consensus: "בבחינות מסוימות Thor: Love and Thunder מרגיש כמו Ragnarok מחדש — אך בסך הכל, הוא מציע מספיק כיף מהיר-קצב כדי להיות תוספת ראויה ל-MCU.",
          source: "Rotten Tomatoes",
  ...
  "ant-man-and-the-wasp-quantumania": {
      knowledge: {
          summary: "Scott Lang נהנה מתהילתו כאווינג'ר, עד שמכשיר שבתו Cassie בנתה בטעות שולח את כל המשפחה ל-Quantum Realm — שם שולט רודן מולטיברסלי גולה בשם Kang the Conqueror.",
          concepts: [
      ...
      review: {
          ...
          metacriticScore: 48,
          consensus: "ל-Ant-Man and the Wasp: Quantumania חסר ברובו הניצוץ הכיפי שהרים הרפתקאות קודמות, אך ה-Kang של Jonathan Majors הוא נבל מרתק שעתיד לשנות את מהלך ה-MCU.",
          source: "Rotten Tomatoes",
  ...
  "guardians-of-the-galaxy-vol-3": {
      knowledge: {
          summary: "עדיין מתאבלים על גרסה קודמת של Gamora, הגארדיאנים מותקפים על ידי ישות מלאכותית בשם Adam Warlock. כש-Rocket נפצע אנושות, הצוות חוזר אל עברו האפל ביותר כדי להציל אותו.",
          concepts: [
      ...
      review: {
          ...
          metacriticScore: 64,
          consensus: "חיבוק גלקטי שאולי לוחץ קצת חזק מדי על מיתרי הלב, ה-Guardians of the Galaxy האחרון הוא פרידה אוהבת מהמשפחה הכי מגובשת ב-MCU.",
          source: "Rotten Tomatoes",
  ...
  "the-marvels": {
      knowledge: {
          summary: "Carol Danvers מתמודדת עם השלכות מהפכה שהובילה נגד ה-Kree. כשלוחמת קריאנית משתמשת בחפץ עתיק שגורם לכוחותיה של Carol להתערבב עם כוחותיהן של שתי גיבורות נוספות, השלוש נאלצות ללמוד לשתף פעולה — פשוטו כמשמעו.",
          concepts: [
      ...
      review: {
          ...
          metacriticScore: 50,
          consensus: "מצחיק, קצר באופן מרענן, ומורם על ידי הכימיה של שלוש הכוכבות המובילות — The Marvels קל ליהנות ממנו ברגע למרות עלילה עמוסה ומעברי טון מבולבלים.",
          source: "Rotten Tomatoes",
  ...
  "deadpool-and-wolverine": {
      knowledge: {
          summary: "Wade Wilson פרש מלהיות Deadpool, אך כשמתברר שהיקום שלו עומד לגווע, ה-TVA מגייסת אותו למצוא גרסת Wolverine שתחליף את זו שמתה ביקומו. השניים נגררים לממד גרוטאות בקצה הזמן שנשלט בידי נבלה טלפתית.",
          concepts: [
      ...
      review: {
          rottenTomatoesScore: 77,
          metacriticScore: 56,
          consensus: "Ryan Reynolds מרגיש כמו בבית ב-MCU עם שנינות חדה, בעוד Hugh Jackman מספק גב אדמנטיום לעלילה — Deadpool & Wolverine היא הרפתקה חצופה עם חיבה מפתיעה לעידן עבר של סרטי גיבורי-על.",
          source: "Rotten Tomatoes",
  ...
  "captain-america-brave-new-world": {
      knowledge: {
          summary: "חמישה חודשים אחרי ש-Thaddeus Ross הופך לנשיא ארה״ב, Sam Wilson — ה-Captain America החדש — נשלח לחקור גניבת פריטים מסווגים. החקירה חושפת קשר בין הנשיא החדש למזימת נקמה ישנה.",
          concepts: [
      ...
      review: {
          rottenTomatoesScore: 46,
          metacriticScore: 44,
          consensus: "Anthony Mackie לוקח בהצלחה את מעטפת ה-Cap והמגן, אך Brave New World שגרתי ועמוס מדי בקריצות משעממות כדי להרגיש כהרפתקה עצמאית ראויה למנהיג האווינג'רס החדש.",
          source: "Rotten Tomatoes",
  ...
  "thunderbolts": {
      knowledge: {
          summary: "קבוצת פעילים סודיים בעייתיים — Yelena Belova, John Walker, Ghost ואחרים — נשלחים על ידי מנהלת ה-CIA למשימה חשאית, ומגלים שהם נועדו לחסל זה את זה. במקום זה הם מתאחדים כדי לחשוף מזימה גדולה בהרבה.",
          concepts: [
      ...
      review: {
          ...
          metacriticScore: 68,
          consensus: "בהובלת חבורת מוצא-לב חסרי מזל עם Florence Pugh כמצטיינת מגנטית, Thunderbolts* חוזר בצורה מרעננת לנוסחה המנוסה של הרפתקאות ה-MCU הטובות ביותר.",
          source: "Rotten Tomatoes",
  ...
  "the-fantastic-four-first-steps": {
      knowledge: {
          summary: "ביקום חלופי משנות ה-60, ארבעה גיבורים שקיבלו כוחות מקרינה קוסמית מתמודדים עם Galactus, ישות שמאיימת לבלוע את כדור הארץ שלהם — ועם שליחה שלו שמגלה שלב שלה.",
          concepts: [
      ...
      review: {
          ...
          metacriticScore: 64,
          consensus: "נהנה מכימיה יציבה בין השחקנים ומעוצב בסגנון רטרו מקסים של שנות ה-60, הניסיון הזה ל-Fantastic Four עושה צדק עם המשפחה הראשונה של מארוול.",
          source: "Rotten Tomatoes",
  ...
  "spider-man-brand-new-day": {
      knowledge: {
          summary: "ארבע שנים אחרי שכולם שכחו את זהותו, Peter Parker פועל לבדו כ-Spider-Man אלמוני. דמות טלפתית מסתורית מתחילה לתקוף מתקני ממשל, וגוררת את Peter למזימה גדולה בהרבה משחשב.",
          concepts: [
      ...
      review: {
          rottenTomatoesScore: 89,
          metacriticScore: 66,
          consensus: "טווה יחד רצף פעולה מרהיב עם עומק רגשי בוגר וביצוע נפשי של Tom Holland — Brand New Day הוא איתחול מבטיח שמנבא שספיידי יישאר דביק על המסך הגדול לשנים רבות.",
          source: "Rotten Tomatoes",
